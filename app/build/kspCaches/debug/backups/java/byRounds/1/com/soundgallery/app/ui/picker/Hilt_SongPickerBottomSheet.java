...
public abstract class Hilt_SongPickerBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SongPickerBottomSheet() {
    super();
  }

  Hilt_SongPickerBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongPickerBottomSheet_GeneratedInjector) this.generatedComponent()).injectSongPickerBottomSheet(UnsafeCasts.<SongPickerBottomSheet>unsafeCast(this));
    }
  }
